...
import com.nanuri.rams.business.common.dto.IBIMS348HDTO;
...
@Getter
/*
 * 딜승인수수료스케줄기본 table(IBIMS348HDTO) VO
 */
public class IBIMS348HVO extends IBIMS348HDTO {
    ...
    List<IBIMS348HVO> feeSchList;               // 수수료스케줄관리 리스트
}
