...
@Getter
@Setter
public class IBIMS100BVO {
	
	@Getter
	@Setter
	public static class selectVO extends IBIMS100BDTO{

		private String     dealNo;                    // DEAL번호-key
		...
		private String     workDcdNm;                 // 작업구분명
		private String     regEnoNm;                  // 요청자명
		
		private Map<String, Object> rmrkMap;		  // 비고Map(메뉴별조회KEY,Value)
	}
