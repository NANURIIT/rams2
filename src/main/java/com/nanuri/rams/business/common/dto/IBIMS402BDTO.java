...
@ToString
/*
 딜실행기본 Table.IBIMS402B DTO
*/
public class IBIMS402BDTO {
	...
	private BigDecimal dealExcAmt; 		/* 딜실행금액 */
	...
	private int totRdmpTmrd; 			/* 총상환회차 */
	private int lastRdmpTmrd; 			/* 최종상환회차 */
	private BigDecimal dealIstmBlce; 	/* 딜할부잔액 */
	private BigDecimal dealEqlRdmpAmt; 	/* 딜균등상환금액 */
	...
	private BigDecimal excAddIntrt;  	/* 실행가산금리 */
	private BigDecimal prcsIntrAmt; 	/* 처리이자금액 */
	private String fndsDcd; 			/* 자금구분코드 */
	private BigDecimal krwTrslIntAmt; 	/* 원화환산이자금액 */
    private BigDecimal expRdmpAmt;  	/* 만기상환금액 */
