...
@Setter
/*
 * 담보정보 Table.RAA06B VO
 * */
public class RAA06BVO {
	...
	private String     mrtgKndCcdNm;			//담보종류구분코드명
	private String     mrtgDtlsCcdNm;			//담보상세구분코드명
	private String     rgtRnkCcdNm;				//권리순위구분코드명
	private String     mrtgAcqstStmCcdNm;		//담보취득방식구분코드명
	private String     mrtgAcqstDtlsCcdNm;		//담보취득상세구분코드명
