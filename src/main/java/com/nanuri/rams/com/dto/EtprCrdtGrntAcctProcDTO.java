...
@Getter
@Setter
public class EtprCrdtGrntAcctProcDTO  {
    ...
    private BigDecimal    trPrca              ; //거래원금
    private BigDecimal    trIntAmt            ; //거래이자금액
    private BigDecimal    rdptObjtPrca    	  ; //상환대상원금
    private BigDecimal    mrdpPrca            ; //중도상환원금
    ...
    private BigDecimal    altnAmt             ; //대체금액
    private BigDecimal    cashAmt             ; //현금금액
    private BigDecimal    bkchAmt             ; //자기앞수표금액
    private BigDecimal    ckblAmt             ; //타점권금액
    ...
    private String        canYn               ; //취소거래여부
    private String        crdtGrntTrKindCd    ; //여신공여거래종류코드
	private String        cpltYn              ; //완료여부
}
