...
function selBox() {
    selectBox = getSelectBoxList("TB08050S", "F004"   // 수수료종류코드 FEE_BNAP_DCD
...
function pqGrid() {
	...
	let colFeeDtls = [
        ...
        { 	
			...
			filter     : { crules: [{ condition: 'range' }] }, 
            colModel   : [
                            { title : "대상금액", dataType : "integer",  dataIndx : "feeStdrAmt", align : "right", halign : "center", align: "right", width : "10%", format : '#,###.00', },
                            { title : "대상내용(계산식)", dataType : "string", dataIndx : "feeTrgtCtns", halign: "center", align : "left",  width : "10%",},
                            { title : "율(%)", dataType : "integer",  dataIndx : "feeRt", halign: "center", align : "right",  width : "10%", format : '#.00',},
            ...
            success: function(data) {
                ...
                if( data.length > 0 ) {
                    ...
                    feeDtls.on("rowDblClick", function( event, ui ) {
                        ...
                        $(`input[name="TB08050S_feeTxtnYn"][value="${rd.feeTxtnYn}"]`).prop('checked', true); // 수수료과세여부
                        ...
                        $(`input[name="TB08050S_prcsCpltYn"][value="${rd.prcsCpltYn}"]`).prop('checked', true); // 수납완료여부
