  ...
  function rebuildMenuListTable(data) {
    ...
    if (menuList.length > 0) {
      $.each(menuList, function (key, value) {
        ...
        if (value.aplyYn === "N") {
          html +=
            '  <td><input class="aply_Yn" style="width:100%"  type="checkbox" ><input class="hidden_yn" type="hidden" value="N"></td>';
        } else {
          html +=
            '  <td><input class="aply_Yn" style="width:100%"  type="checkbox" checked><input class="hidden_yn" type="hidden" value="Y"></td>';
        }
        html += "</tr>";
      });
    } else {
      ...
      if (mainMenuList.length > 0) {
        for (let i = 0; i < mainMenuList.length; i++) {
          ...
          html +=
            '   <td><input id="' +
            menuInfo.menuId +
            '" style="width:100%" type="checkbox"><input type="hidden" value="' +
            menuId +
            '"></td>';
          html +=
            '   <td class="update_column menuId">' + menuInfo.menuId + "</td>"; //메뉴ID
          html += '   <td class="update_column">' + menuInfo.sortNo + "</td>"; //정령번호
          html +=
            '   <td class="update_column">' + menuInfo.urlVrbCntn + "</td>"; //화면번호
          ...
          html +=
            '   <td class="update_column">' + menuInfo.urlClsfCd + "</td>"; //URL분류코드
