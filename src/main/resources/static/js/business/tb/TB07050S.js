...
function pqGrid(f) {
    ...
    switch (f) {
        case "02":
            ...
            $("#prnaRdmpSchGrid .pq-toolbar .ui-button").attr("id", "download-file-TB07050S");	//엑셀 다운로드 버튼 id부여
            break;
        ...
        case "04":
            ...
            $("#intrRdmpSchGrid .pq-toolbar .ui-button").attr("id", "download-file-TB07050S");	//엑셀 다운로드 버튼 id부여
            // aplyIrt 이자율
        ...
        case "01":
            ...
            $("#excSchGrid .pq-toolbar .ui-button").attr("id", "download-file-TB07050S");	//엑셀 다운로드 버튼 id부여
            break;
        default:
            break;
    };
    ...
    switch (p) {
        case "p":
            if ( scxDcd === "02" && validation().isValid ) {
                ...
                grdID.addRow( { rowIndx: prnaRdmpSchLen + 1, rowData: newRow, checkEditable: false } );
                chkGrd(grdID);
            };
            ...
            if ( scxDcd === "04" && validation().isValid ) {
                ...
                //let gLen = grd.length;
                grdID.addRow( { rowIndx: intrRdmpSchLen + 1, rowData: newRow, checkEditable: false } );
                chkGrd(grdID);
            };
            ...
            if ( scxDcd === "01" && validation().isValid ) {
                ...
                //let gLen = grd.length;
                grdID.addRow( { rowIndx: excSchLen + 1, rowData: newRow, checkEditable: false } );
                chkGrd(grdID);
            };
