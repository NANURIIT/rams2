let rdmpTrgtDtlsIns;            //상환대상내역 grid instance
let selectBox;
let dprtList = {};
let crryCdList = {};
...
function rdmpTrgtDtlsInq(){
    ...
    function businessFunction(){
        ...
        $.ajax({
            ...
            dataType: "json",
            beforeSend: function(){
                $("#TB09070S_rdmpTrgtDtlsGrid").pqGrid("option", "strNoRows", "조회 중입니다...");
            },
            success: function(data) {
                //console.log(JSON.stringify(data));

                $("#TB09070S_rdmpTrgtDtlsGrid").pqGrid("option", "strNoRows", "조회된 데이터가 없습니다.");
