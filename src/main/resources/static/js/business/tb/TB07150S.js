	...
	let obj = [
		...
		},
        {
			...
			, editable	: function() {
				...
				if($("#TB07150S_R023_1").val() == "31" || $("#TB07150S_R023_1").val() == "04"){
					isEditable = true;
				}
...
function cndChng() {								//조건변경
	...
	function businessFunction(){
		...
		var cndChng346BList = $("#grd_intrtInf_2").pqGrid('option', 'dataModel.data');			//변경 후 금리정보
