...
function fnSelectBox() {
    selectBox = getSelectBoxList("TB07180",
        "/F004"
        + "/F006"
        + "/A005"
        + "/R012"
...
function TB07180S_colModelData() {
    const TB07180S_colModel1 = [
        ...
        , {
            ...
            render: function (ui) {
                let fSel = grdSelect.R012.find(({ cdValue }) => cdValue == ui.cellData);
                return fSel ? fSel.cdName : ui.cellData;
            }
        }
        , {
            ...
            render: function (ui) {
                let fSel = grdSelect.F015.find(({ cdValue }) => cdValue == ui.cellData);
                return fSel ? fSel.cdName : ui.cellData;
            }
        }
        , {
        ...
        , {
            ...
            render: function (ui) {
                let fSel = grdSelect.A001.find(({ cdValue }) => cdValue == ui.cellData);
                return fSel ? fSel.cdName : ui.cellData;
            }
        }
        , {
            ...
            render: function (ui) {
                let fSel = grdSelect.A004.find(({ cdValue }) => cdValue == ui.cellData);
                return fSel ? fSel.cdName : ui.cellData;
            }
        }
        , {
...
function TB07180S_addNewRow(colModelId) {
    ...
    colModelIdSelector(colModelId).pqGrid("addRow", { rowData: newRow, checkEditable: false });
}
...
function TB07180S_deleteRow(colModelId, yourFunction) {
    ...
    if (TB07180S_rowData != TB07180S_dummyData && TB07180S_pqGridLength < getLength && !TB07180S_rowData.excSn) {
        colModel.pqGrid("deleteRow", { rowData: TB07180S_rowData, checkEditable: false });
        TB07180S_rowData = TB07180S_dummyData;
    } else if (TB07180S_rowData === TB07180S_dummyData && TB07180S_pqGridLength < getLength) {
        colModel.pqGrid("deleteRow", { rowData: TB07180S_rowData, checkEditable: false });
        TB07180S_rowData = TB07180S_dummyData;
    } else if (TB07180S_rowData === TB07180S_dummyData && TB07180S_pqGridLength === getLength) {
